# Generated by Django 2.2.1 on 2019-07-02 21:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('area', models.ManyToManyField(blank=True, to='usuario.Area')),
                ('cargo', models.ManyToManyField(blank=True, to='usuario.Tipo')),
